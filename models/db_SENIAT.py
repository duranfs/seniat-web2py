...
db.define_table('rutinas',
    ...
    Field('descripcion', 'text', label='Descripción',
        ...
        widget=lambda field, value: SQLFORM.widgets.text.widget(field, value, _rows=5, _cols=130)),
    Field('sql_code', 'text', required=True, label='Código SQL',
        represent=lambda x: MARKMIN(x), 
        unique=True,
        widget=lambda field, value: SQLFORM.widgets.text.widget(field, value, _rows=15, _cols=130)),
