...
settings = Storage()
T.current_languages = ['es']
#settings.migrate = True
#settings.fake_migrate = True
settings.title = 'SIM-DBD'
settings.subtitle = 'manage time and location'
settings.author = 'Duran'
settings.author_email = 'duranfs.2012@gmail.com'
settings.keywords = ''
